...
- OpenAI Responses API·File Search 기반 자연어 검색, 문서 증분 동기화, 권한별 인용 답변과 수정 이력 관리를 구축했습니다.
- **산책회 모바일 웹** — 산책·일지·추천코스·회원·마일리지 UX를 개선하고 NICE SMS 인증과 Cafe24 OAuth 계정 연동을 구현했습니다.
- 사진·지도·알림·비밀번호 입력 오류를 자동 테스트와 모바일 브라우저·Android 에뮬레이터에서 검증했습니다.
<!-- WOOJUTECH:END -->
